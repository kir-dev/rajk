    ...
    return (
        <>
            {isLoading ? (
                ...
                <div>
                    <h2 className="py-2 px-6 mb-6 bg-white hover:bg-gray-100 text-black text-center text-2xl font-medium border-2 border-black rounded-2xl transition-colors">{(amount / 100).toLocaleString('hu-HU')} Ft</h2>
