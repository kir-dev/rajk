            ...
            <div className="bg-card border border-border rounded-lg overflow-hidden">
                <div className="grid md:grid-cols-[300px_1fr] gap-6 p-6 md:p-8">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">{awardee.name}</h3>
              ...
              <span className="flex items-center gap-1">
                ...
                <BookOpen className="w-4 h-4"/>
                        ...
                        <p className="text-foreground leading-relaxed mb-4">{awardee.description}</p>
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                        <h3 className="text-lg md:text-xl font-semibold text-foreground truncate">{awardee.name}</h3>
                        {awardee.hasNobel && (
                            <span
