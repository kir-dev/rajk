            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-border mb-16">
                    {stats.map((stat, index) => (
                        <div key={index} className="bg-background p-8 md:p-12 text-center md:text-left">
                ...
                <div className="bg-card border border-border rounded-lg p-8 md:p-12">
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Miben egyedi?</h2>
                            <p className="text-muted-foreground">A díjazási folyamat, ami megkülönbözteti a Neumann-díjat</p>
                        </div>
                    </div>

                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-foreground">Hallgatói jelölés</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-foreground">Demokratikus szavazás</h3>
                            <p className="text-muted-foreground leading-relaxed">
