...
export default function LandingPage(props: LandingPageProps) {
    ...
    return (
        <div className = "min-h-screen min-w-screen flex flex-col pb-40 bg-bezs">
            ...
            <VertNavBarLayout>
                <Section id = {"rolunk"} title = {"Közösség"} lucideIconName="Users">
                ...
                <Section id = {"szakma"} title = {"Szakma"} lucideIconName="GraduationCap">
                ...
                <Section id = {"tarsadalmi"} title = {"Társadalmi felelősségvállalás"} lucideIconName="Handshake">
                    <div className = "flex flex-col h-full rounded-2xl">
                        <PillarCard
                        ...
                        />
                        <Statistics isLast = {false} color = {"green"} szin = {"zold"}
                                    title = {"Társadalmi felelősségvállalás"}
                                    data = {
                                        [
                ...
                <Section id = {"events"} title = {"Események"} lucideIconName="Calendar">
                    <div className = "w-full flex justify-center">
                        <IconTitle className = "mt-20 text-black" title = {"Események"} Icon = {Calendar}/>
                    </div>
                    <MyCarousel data = {props.data}/>
                </Section>
                <Section id = "location" title = "Helyszín" lucideIconName="MapPin">
                    <div
                        className = "relative bg-bezs text-black py-16 px-4 sm:px-6 lg:px-8 rounded-3xl mt-10 mb-20 overflow-hidden">
                        <div className = "relative max-w-7xl mx-auto">
                            ...
                            <div className = "grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
                                <div
                                    className = "lg:col-span-2 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(28,150,71,0.3)] transition-all duration-500 hover:shadow-[0_0_50px_rgba(28,150,71,0.5)]">
                                ...
                                <div
                                    className = " p-8 rounded-2xl border border-rajk-green/20 hover:border-rajk-green/40 transition-all duration-300 flex flex-col space-y-6">
                                    ...
                                    <div className = "flex flex-col space-y-2">
                                        ...
                                        <ul className = " space-y-1">
                                            ...
                                            <span
                                                className = "inline-block w-9 h-9 p-1 rounded-full bg-blue-900  text-white text-center font-bold">M3</span>
                                                <span>Kálvin tér (5 perc séta)</span>
                                            </li>
                                            <li className = "flex items-center gap-2">
                                            <span
                                                className = "inline-block w-9 h-9 p-1 rounded-full bg-green-700 text-white text-center font-bold">M4</span>
                                                <span>Kálvin tér (5 perc séta)</span>
                                            </li>
                                            <li className = "flex items-center gap-2">
                                            <span
                                                className = "inline-block w-9 h-9 p-1 rounded-full bg-yellow-500 text-white text-center font-bold">4-6</span>
