...
export function PillarCard({ title, description, icon: Icon, buttonText, href, imageSrc }: PillarCardProps) {
    return (
        <div className="container mx-auto px-4">
            <div className="group flex flex-col gap-4 h-full w-full max-w-6xl mx-auto p-6 transition-all duration-300 text-black rounded-2xl mb-20 mt-10">
                ...
                <div className="flex flex-col md:flex-row gap-6 mt-4">
                    ...
                    <div className="flex-shrink-0 overflow-hidden rounded-2xl h-[500px] w-[500px] relative md:mr-4">
                        <Image
                            src={imageSrc}
                            alt="Koli"
                            fill
