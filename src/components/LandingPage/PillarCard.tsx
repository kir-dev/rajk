...
export function PillarCard({ title, description, icon: Icon, buttonText, href }: PillarCardProps) {
    return (
        <div className="group flex flex-col gap-4 h-full w-full p-6 transition-all duration-300 text-black rounded-2xl mb-20 hover:shadow-lg hover:-translate-y-1 mt-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-4">
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-2xl h-[200px] w-[200px] relative">
                    <Image
                        src="/koli.png"
                        alt="Koli"
                        fill
